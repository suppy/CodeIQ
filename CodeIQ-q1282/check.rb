...
#puts line
  ...
  next if right_answer == "なし"
  min = right_answer.to_f
  #print "#{right_answer.rindex(/上|く/, -1)}\n"
  #print "#{right_answer[(right_answer.rindex(/上|く/, -1)+1)..-1]}\n"
  max = right_answer[(right_answer.rindex(/上|く/, -1)+1)..-1].to_f
  #print "#{min} #{max}\n"
