...
def neighbor?(seats, index)
  return false if index == 0 && seats[1] == 0 # 左上
  return false if index == @n/2-1 && seats[@n/2-2] == 0 # 右上
  return false if index == @n/2 && seats[@n/2+1] == 0 # 左下
  return false if index == @n-1 && seats[@n-2] == 0 # 右下
  return false if seats[index-1] == 0 && seats[index+1] == 0 # 両隣り
